  ...
  <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    <div style="background: white; padding: 30px; border-radius: 0 0 12px 12px; box-shadow: 0 4px 6px rgba(0,0,0,0.05);">
      ...
      <div style="background: #f8fafc; border-radius: 8px; padding: 20px; margin-bottom: 24px; border-left: 4px solid #0F4C81;">
        ...
        <table style="width: 100%; border-collapse: collapse;">
          <tr>
            ...
            <td style="padding: 8px 0; color: #111827; font-size: 14px; font-weight: 500;">${data.name || 'Not provided'}</td>
          </tr>
          <tr>
            <td style="padding: 8px 0; color: #6b7280; font-size: 14px;">Email:</td>
            <td style="padding: 8px 0;">
              <a href="mailto:${data.email}" style="color: #0F4C81; text-decoration: none; font-size: 14px; font-weight: 500;">${data.email}</a>
            </td>
          </tr>
          ${data.phone ? `
          <tr>
            ...
            <td style="padding: 8px 0;">
              <a href="tel:${data.phone}" style="color: #0F4C81; text-decoration: none; font-size: 14px; font-weight: 500;">${data.phone}</a>
            </td>
          </tr>
          ` : ''}
          <tr>
      ...
      <div style="background: #fef3c7; border-radius: 8px; padding: 20px; margin-bottom: 24px; border-left: 4px solid #f59e0b;">
        ...
        <table style="width: 100%; border-collapse: collapse;">
          ...
          <tr>
            ...
            <td style="padding: 8px 0; color: #78350f; font-size: 14px; font-weight: 500;">${data.legal_capacity}</td>
          </tr>
          ` : ''}
          ${data.company_represented ? `
          <tr>
            <td style="padding: 8px 0; color: #92400e; font-size: 14px;">Representing:</td>
            <td style="padding: 8px 0; color: #78350f; font-size: 14px; font-weight: 500;">${data.company_represented}</td>
          </tr>
          ` : ''}
        </table>
      </div>
      ...
      <div style="background: #f0fdf4; border-radius: 8px; padding: 20px; margin-bottom: 24px; border-left: 4px solid #22c55e;">
        ...
        <table style="width: 100%; border-collapse: collapse;">
          ...
          <tr>
            ...
            <td style="padding: 8px 0; color: #14532d; font-size: 14px; font-weight: 500;">${data.adjuster_name}</td>
          </tr>
          ` : ''}
          ...
          <tr>
            ...
            <td style="padding: 8px 0;">
              <a href="${data.adjuster_profile_url}" style="color: #15803d; text-decoration: none; font-size: 14px; word-break: break-all;">${data.adjuster_profile_url}</a>
            </td>
          </tr>
          ` : ''}
        </table>
      ...
      <div style="margin-bottom: 24px;">
        ...
        <p style="margin: 0; font-size: 18px; color: #111827; font-weight: 600;">${data.subject}</p>
      </div>
      ` : ''}
      ...
      <div style="margin-bottom: 24px;">
        ...
        <div style="background: #f9fafb; border-radius: 8px; padding: 20px; border: 1px solid #e5e7eb;">
          <p style="margin: 0; font-size: 15px; color: #374151; white-space: pre-wrap; word-break: break-word;">${data.message}</p>
        </div>
      </div>
      ...
      <div style="border-top: 1px solid #e5e7eb; padding-top: 24px; text-align: center;">
        ...
        ${data.adjuster_profile_url ? `
        <a href="${data.adjuster_profile_url}" 
...
`;
  ...
  if (data.inquiry_type === 'adjuster' || data.inquiry_type === 'removal') {
    text += `
