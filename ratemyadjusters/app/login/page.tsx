      ...
      <div className="max-w-md w-full">
        <div className="bg-white rounded-2xl shadow-sm p-8">
          ...
          {mode !== 'forgot' && (
            <>
              ...
              <button
                ...
                disabled={loading}
                className="w-full flex items-center justify-center gap-3 bg-white border border-gray-300 hover:border-gray-400 text-gray-700 font-medium py-3 px-4 rounded-lg transition-colors mb-4"
              >
          ...
          <div className="mt-8 pt-6 border-t border-gray-200">
            <Link
              href={redirectTo}
              className="w-full flex items-center justify-center gap-2 text-gray-600 hover:text-gray-900 font-medium py-3 px-4 rounded-lg border border-gray-200 hover:border-gray-300 transition-colors"
            >
              Continue Without Login
