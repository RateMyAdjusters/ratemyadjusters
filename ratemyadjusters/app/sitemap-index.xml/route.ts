...
// File: app/sitemap-index.xml/route.ts (or wherever your current sitemap index is)

import { NextResponse } from 'next/server';

const URLS_PER_PAGE = 10000;

// Your actual adjuster counts per state
...
`;
  ...
  // Generate paginated sitemaps for each state
