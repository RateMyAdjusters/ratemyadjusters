...
import { Share2, Copy, Check, Mail, Facebook, Twitter } from 'lucide-react'
            ...
            <div className="py-2">
              ...
              >
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M3 3h6v6H3V3zm2 2v2h2V5H5zm8-2h6v6h-6V3zm2 2v2h2V5h-2zM3 13h6v6H3v-6zm2 2v2h2v-2H5zm13-2h3v2h-3v-2zm-5 0h2v2h-2v-2zm2 2h2v2h-2v-2zm-2 2h2v2h-2v-2zm2 2h2v2h-2v-2zm2-2h3v4h-2v-2h-1v-2zm0-2v-2h3v2h-3z"/>
                </svg>
                Generate QR Code
              </button>
            </div>
